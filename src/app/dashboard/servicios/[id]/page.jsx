...
export default function EditServicePage() {
    ...
    return (
        isAdmin ? (
            ...
            <div className="max-w-3xl mx-auto mt-8 p-6 bg-white rounded-xl shadow-md">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">Editar Servicio: {form.nombre} (solo precio)</h1>
                    <button
                        className="bg-red-300 text-white font-semibold px-4 py-2 rounded-lg transition cursor-not-allowed"
                        disabled
                    >
                        Eliminar Servicio
                    </button>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            required
                            className="w-full border border-gray-300 bg-gray-200 cursor-not-allowed rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
                            disabled
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleChange}
                                disabled
                                className="w-full border border-gray-300 bg-gray-200 cursor-not-allowed rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 capitalize"
                            >
                                {tipos.map((t) => (
                                    <option key={t} value={t} className="capitalize">
                                        {t.toLowerCase()}
